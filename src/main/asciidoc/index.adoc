...
include::{snippets}/get-games-id/http-request.adoc[]

==== Path parameters

include::{snippets}/get-games-id/path-parameters.adoc[]

=== Example request

include::{snippets}/get-games-id/curl-request.adoc[]

==== Example response

include::{snippets}/get-games-id/http-response.adoc[]